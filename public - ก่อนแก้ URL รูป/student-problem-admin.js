    ...
    if (classInfoContainer) {
        classInfoContainer.innerHTML = `
            <div class="class-header">
                <h2 id="className">โจทย์พิเศษจากผู้ดูแลระบบ</h2>
                <div class="class-code">สำหรับนักเรียนทุกคน</div>
                <div class="teacher-profile">
                    <img src="${adminData.photoURL || defaultAvatar}" 
                         alt="ผู้ดูแลระบบ"
                         class="teacher-image">
                    <div class="teacher-info">
                        <div class="teacher-name">
                            Admin ${adminData.displayName || 'ไม่ระบุชื่อ'}
                        </div>
                        <div class="teacher-email">${adminData.email}</div>
                    </div>
                </div>
            </div>
        `;
